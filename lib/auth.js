...
import { getAuthors, verifyReaderPassword, verifyUserPassword } from "@/lib/db";
...
export function authenticateReader(username, password) {
  return verifyReaderPassword(username, password);
}
